		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getRelationalExprAccess().getOpAlternatives_1_0_1_0(), "rule__RelationalExpr__OpAlternatives_1_0_1_0");
					put(grammarAccess.getPlusExprAccess().getOpAlternatives_1_0_1_0(), "rule__PlusExpr__OpAlternatives_1_0_1_0");
					put(grammarAccess.getTimesExprAccess().getOpAlternatives_1_0_1_0(), "rule__TimesExpr__OpAlternatives_1_0_1_0");
					...
					put(grammarAccess.getVarGroupAccess().getGroup(), "rule__VarGroup__Group__0");
					put(grammarAccess.getVarGroupAccess().getGroup_1(), "rule__VarGroup__Group_1__0");
					...
					put(grammarAccess.getNodeAccess().getPropertiesAssignment_12_1(), "rule__Node__PropertiesAssignment_12_1");
					put(grammarAccess.getNodeAccess().getAssertionsAssignment_12_2(), "rule__Node__AssertionsAssignment_12_2");
					put(grammarAccess.getNodeAccess().getMainAssignment_12_3(), "rule__Node__MainAssignment_12_3");
					put(grammarAccess.getVarGroupAccess().getVarsAssignment_0(), "rule__VarGroup__VarsAssignment_0");
					put(grammarAccess.getVarGroupAccess().getVarsAssignment_1_1(), "rule__VarGroup__VarsAssignment_1_1");
					put(grammarAccess.getVarGroupAccess().getTypeAssignment_3(), "rule__VarGroup__TypeAssignment_3");
					...
					put(grammarAccess.getArrowExprAccess().getOpAssignment_1_0_1(), "rule__ArrowExpr__OpAssignment_1_0_1");
					put(grammarAccess.getArrowExprAccess().getRightAssignment_1_0_2(), "rule__ArrowExpr__RightAssignment_1_0_2");
					put(grammarAccess.getImpliesExprAccess().getOpAssignment_1_0_1(), "rule__ImpliesExpr__OpAssignment_1_0_1");
					put(grammarAccess.getImpliesExprAccess().getRightAssignment_1_0_2(), "rule__ImpliesExpr__RightAssignment_1_0_2");
					put(grammarAccess.getOrExprAccess().getOpAssignment_1_0_1(), "rule__OrExpr__OpAssignment_1_0_1");
					put(grammarAccess.getOrExprAccess().getRightAssignment_1_0_2(), "rule__OrExpr__RightAssignment_1_0_2");
					put(grammarAccess.getAndExprAccess().getOpAssignment_1_0_1(), "rule__AndExpr__OpAssignment_1_0_1");
					put(grammarAccess.getAndExprAccess().getRightAssignment_1_0_2(), "rule__AndExpr__RightAssignment_1_0_2");
					put(grammarAccess.getRelationalExprAccess().getOpAssignment_1_0_1(), "rule__RelationalExpr__OpAssignment_1_0_1");
					put(grammarAccess.getRelationalExprAccess().getRightAssignment_1_0_2(), "rule__RelationalExpr__RightAssignment_1_0_2");
					put(grammarAccess.getPlusExprAccess().getOpAssignment_1_0_1(), "rule__PlusExpr__OpAssignment_1_0_1");
					put(grammarAccess.getPlusExprAccess().getRightAssignment_1_0_2(), "rule__PlusExpr__RightAssignment_1_0_2");
					put(grammarAccess.getTimesExprAccess().getOpAssignment_1_0_1(), "rule__TimesExpr__OpAssignment_1_0_1");
					put(grammarAccess.getTimesExprAccess().getRightAssignment_1_0_2(), "rule__TimesExpr__RightAssignment_1_0_2");
