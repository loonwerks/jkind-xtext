		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getAtomicExprAccess().getGroup_8_6(), "rule__AtomicExpr__Group_8_6__0");
					...
					put(grammarAccess.getAtomicExprAccess().getTypeAssignment_8_1(), "rule__AtomicExpr__TypeAssignment_8_1");
					put(grammarAccess.getAtomicExprAccess().getFieldsAssignment_8_3(), "rule__AtomicExpr__FieldsAssignment_8_3");
					put(grammarAccess.getAtomicExprAccess().getExprsAssignment_8_5(), "rule__AtomicExpr__ExprsAssignment_8_5");
					put(grammarAccess.getAtomicExprAccess().getFieldsAssignment_8_6_1(), "rule__AtomicExpr__FieldsAssignment_8_6_1");
					put(grammarAccess.getAtomicExprAccess().getExprsAssignment_8_6_3(), "rule__AtomicExpr__ExprsAssignment_8_6_3");
