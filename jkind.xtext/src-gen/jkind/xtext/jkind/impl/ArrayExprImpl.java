 ...
 * <ul>
 *   <li>{@link jkind.xtext.jkind.impl.ArrayExprImpl#getExprs <em>Exprs</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ArrayExprImpl extends ExprImpl implements ArrayExpr
{
  ...
  {
    return JkindPackage.Literals.ARRAY_EXPR;
  }
  ...
  public EList<Expr> getExprs()
  {
    if (exprs == null)
    {
      exprs = new EObjectContainmentEList<Expr>(Expr.class, this, JkindPackage.ARRAY_EXPR__EXPRS);
    }
    return exprs;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case JkindPackage.ARRAY_EXPR__EXPRS:
