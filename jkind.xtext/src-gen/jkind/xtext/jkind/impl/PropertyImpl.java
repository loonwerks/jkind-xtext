 ...
 * <ul>
 *   <li>{@link jkind.xtext.jkind.impl.PropertyImpl#getRef <em>Ref</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PropertyImpl extends MinimalEObjectImpl.Container implements Property
{
  ...
  {
    return JkindPackage.Literals.PROPERTY;
  }
    ...
    if (ref != null && ref.eIsProxy())
    {
      ...
      if (ref != oldRef)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, JkindPackage.PROPERTY__REF, oldRef, ref));
      }
    }
    return ref;
  }
