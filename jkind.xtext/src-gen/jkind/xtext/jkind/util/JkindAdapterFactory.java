...
public class JkindAdapterFactory extends AdapterFactoryImpl
{
  ...
  protected JkindSwitch<Adapter> modelSwitch =
    new JkindSwitch<Adapter>()
    {
      ...
      @Override
      public Adapter caseIvc(Ivc object)
      {
        return createIvcAdapter();
      }
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link jkind.xtext.jkind.Ivc <em>Ivc</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public Adapter createIvcAdapter()
  {
    return null;
  }

  /**
   * Creates a new adapter for an object of class '{@link jkind.xtext.jkind.RealizabilityInputs <em>Realizability Inputs</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public Adapter createRealizabilityInputsAdapter()
  {
    return null;
  }
